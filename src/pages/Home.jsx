    ...
    <div className="w-full">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-48">
          <div className="max-w-3xl">
            ...
            <p className="text-lg mb-8">
              Exquisite fragrances crafted with the finest ingredients, designed
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-serif tracking-wide text-gray-900">
            Featured Fragrances
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-gray-500">
            Our most coveted scents, carefully selected for their unique
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                At ETHEREAL SCENT, we believe that a fragrance is more than just
                a scent—it's an expression of personality, a trigger for
                memories, and a statement of style.
              </p>
              <p className="text-gray-600 mb-6">
                Each of our perfumes is meticulously crafted by master perfumers
                using the finest ingredients sourced from around the world,
                creating unique compositions that tell a story.
              </p>
              <Link
                to="/about"
